...
public class MakeAPIDB {
	public static void main(String args[]) {
		...
		try {
			...
			s.executeUpdate(
					"CREATE TABLE package " + "(id INT, name VARCHAR(80))");
			...
			System.err.println(
					"Usage: java MakeAPIDB " + "<classlistfile> <propfile>");
		}
	 ...
	 * This is the only one we need to store temporarily. The others are stored
	 * in the db and don't have to be looked up by this program
	 **/
