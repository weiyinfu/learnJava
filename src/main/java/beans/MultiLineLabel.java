 ...
 * margins and alignment. In Java 1.1 we could also subclass Component, making
 * this a "lightweight" component. Instead, we try to maintain Java 1.0
 * compatibility for this component. This means that you will see deprecation
 * warnings when you compile this class with Java 1.1 or later.
 **/
 ...
 * we'd like to be. In Java 1.1, getPreferredSize() is the preferred version
 * of this method. We use this deprecated version so that this component can
 ...
 * minimum amount of space we need to get by. For Java 1.1, we'd use
 * getMinimumSize().
 */
 ...
 * superclass takes care of setting those in the Graphics object we're
 * passed.
 **/
