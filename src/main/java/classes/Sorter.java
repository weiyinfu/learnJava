...
public class Sorter {
	 ...
	 * To sort objects of a given type, you must provide a Comparer object with
	 * a compare() method that orders those objects as desired
	 **/
	public static interface Comparer {
		/**
		 * Compare objects, return a value that indicates their relative order:
		 * if (a > b) return > 0; if (a == b) return 0; if (a < b) return < 0.
		 **/
	 ...
	 * class implements this Comparable interface, then any two instances of
	 * that class can be directly compared by invoking the compareTo() method.
	 **/
	public static interface Comparable {
		/**
		 * Compare objects, return a value that indicates their relative order:
		 * if (this > other) return > 0 if (this == other) return 0 if (this <
		 * other) return < 0
		 **/
	 ...
	 * that compares two ASCII strings. It is used in the sortAscii methods
	 * below.
	 **/
	 ...
	 * default locale. If up is true, sort ascending, otherwise, sort
	...
	/**
	 * Sort a portion of an array of strings, using the collation order of the
	 * specified locale. If up is true, sort ascending, otherwise, sort
	 * descending. If ignorecase is true, ignore the capitalization of letters
	 **/
	...
	/**
	 * Sort a portion of an array of Comparable objects. If up is true, sort
	 * into ascending order, otherwise sort into descending order.
	 **/
	 ...
	 * ascending order, otherwise sort into descending order. Re-arrange the
	 * array b in exactly the same way as a.
	 **/
	...
	/**
	 * This nested class defines a test program that demonstrates several ways
	 * to use the Sorter class to sort ComplexNumber objects
	 **/
	public static class Test {
		/**
		 * This subclass of ComplexNumber implements the Comparable interface
		 * and defines a compareTo() method for comparing complex numbers. It
		 * compares numbers based on their magnitude. I.e. on their distance
		 * from the origin.
		 **/
