...
JButton exitButton, resetButton, restartButton; // 退出，重列，重新开始按钮
...
public void remove() {
    ...
    scoreLable.setText(String.valueOf(Integer.parseInt(scoreLable.getText()) + 100));
